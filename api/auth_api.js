...
// // GET All Users
// api.get('/all', async function(req, res, next) { console.log("hahahahaha: " + req.header('Authorization')); return res.json( await user_controller.getUsers_All());});

// //POST Create User
// api.post('/create', async function(req, res, next) {return res.json( await user_controller.createUser(req.body));});
